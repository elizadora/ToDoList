...
public class TasksCategoriesArrayAdapter extends RecyclerView.Adapter<TasksCategoriesArrayAdapter.ViewHolder>{
    ...
    public TasksCategoriesArrayAdapter(int layoutId, ArrayList<TaskModel> itemList, ArrayList<String> itemIds) {
    ...
    @NonNull
    @Override
    public TasksCategoriesArrayAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(listItemLayout, parent, false);
        return new TasksCategoriesArrayAdapter.ViewHolder(view, this);
    }

    @Override
    public void onBindViewHolder(@NonNull TasksCategoriesArrayAdapter.ViewHolder holder, int position) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private TasksCategoriesArrayAdapter adapter;

        public CheckBox checkTask;

        public ViewHolder(View itemView, TasksCategoriesArrayAdapter adapter) {
            super(itemView);
